...
ActiveRecord::Schema.define(:version => 20130207093503) do
  ...
  add_index "order_item_details", ["serial_number"], :name => "index_order_item_details_on_serial_number"
  add_index "order_item_details", ["ticket_status_id"], :name => "index_order_item_details_on_ticket_status_id"
  ...
  create_table "warrant_purchases", :force => true do |t|
  ...
  add_index "warrant_purchases", ["order_id"], :name => "index_warrant_purchases_on_order_id"
  add_index "warrant_purchases", ["warrant_id"], :name => "index_warrant_purchases_on_warrant_id"
