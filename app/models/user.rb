class User < ActiveRecord::Base
  ...
  attr_accessible :email, :password, :password_confirmation, :remember_me, :fullname, :username, :category_id, :branch_id, :agent_group_id, :address, :phone, :fax, :remark, :active
